...
//			appendString.beginEditing()
			appendString.addAttribute(NSAttributedString.Key.link, value:urlStr, range:range)
//			appendString.endEditing()
			appendString.addAttribute(NSAttributedString.Key.underlineStyle, value: NSNumber.init(integerLiteral: NSUnderlineStyle.single.rawValue), range: range)
		}
