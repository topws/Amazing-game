...
////  BibleGuardian
////
////  Created by Avazu Holding on 2019/1/3.
...
//
//	private static let maxNum = 8
//
//	class func getCoordinates(words: [String]) -> [WordCoordinateStruct] {
//
//		var models: [WordCoordinateStruct] = []
//
